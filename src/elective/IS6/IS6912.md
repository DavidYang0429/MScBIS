...
::: info 官方课程资料与历史经验
**最后核对：** 2026-07-30<br>
**2026/27 官方资料：** 6 学分；标准修读期为两个学期（26 周）；课程页列出 Semester A 2026/27、Semester B 2026/27 与 Summer 2027。官方另列一个 13 周例外，但只适用于从 CityUHK（Dongguan）来港进行全日制研究的 inbound exchange students，并须取得课程负责人、导师及学系主任等批准。<br>
**使用边界：** 下方项目流程和学生评论主要来自 2022 年经验；导师、题目、注册方式、提交节点及当期执行仍以 AIMS、Canvas、项目通知和导师要求为准。

- [CityUHK 2026/27 课程页：IS6912](https://www.cityu.edu.hk/catalogue/pg/202627/course/IS6912.htm)
- [CityUHK 官方课程 PDF：IS6912](https://www.cityu.edu.hk/catalogue/pg/202627/course/IS6912.pdf)
- [Department of Information Systems：2026/27 课程结构中的 IS6912 学期组合](https://www.cb.cityu.edu.hk/en/is/msbda)
- [CityUHK：Master Class Schedule 查询说明](https://www.cityu.edu.hk/arro/content_printver.asp?cid=710)

**本页更新：** 补充 2026/27 课程网页、PDF 与课表查询直链；按官方课程页修正修读期说明，并把一学期例外的适用对象写清楚。
:::
...
:::
::: warning 大学分课程
IS6912 为 6 学分课程，普通 MSBIS 学生的官方标准修读期是两个学期；Information Systems 学系的 2026/27 课程结构把常见组合列为 Semester A + B 或 Semester B + Summer。最终组合和注册资格须以当期 AIMS、项目通知及导师确认结果为准。[此处](../../Useful/CourseEnroll/time_arrangement)保留往届排课示例并说明当前边界。
:::
...
::: warning 2025 Fall 历史导师列表
以下导师、方向、研讨会时间和邮件流程只对应 2025 Fall，未按 2026/27 重新核验。准备 IS6912 时请以当期项目邮件、Canvas、AIMS 与课程负责人通知为准。
:::
